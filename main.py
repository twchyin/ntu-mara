...
MOCK_WEEKS = [
    ...
    {"week": "Week 7",      "theme": "Python & ETL Skills Assessment","objectives": "Complete the hands-on Python & ETL assessment on your local environment\nImplement a full pipeline: ingest → transform → load → report\nSubmit your .py script and output files via the course portal before the deadline", "max_points": 100, "admin_step": 0, "user_score": None},
    {"week": "Week 7 Quiz", "theme": "ETL Pipeline",                  "objectives": "Build an end-to-end ETL script\nSchedule a pipeline run\nGenerate a summary report",                                                                         "max_points": 2,   "admin_step": 0, "user_score": None},
